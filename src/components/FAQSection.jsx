...
const {FiHelpCircle,FiChevronDown,FiChevronUp}=FiIcons;
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <div className="flex justify-center mb-4">
            <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center">
              <SafeIcon icon={FiHelpCircle} className="text-blue-600 text-2xl" />
            </div>
          </div>
        ...
        <div className="space-y-4">
          {faqs.map((faq,index)=> (
            <motion.div
              key={index}
              className={`border rounded-lg overflow-hidden ${openIndex===index ? 'border-blue-300 bg-blue-50' : 'border-gray-200'}`}
            ...
            >
              ...
              >
                ...
                <SafeIcon
                  ...
                  className={`text-xl transition-transform ${openIndex===index ? 'text-blue-600' : 'text-gray-500'}`}
                />
              </button>
              <motion.div
