      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            {/* Volunteer Button - Glassy Style */}
            <div className="px-4 pb-2 flex-shrink-0">
              <button
                onClick={handleVolunteerClick}
                className="w-full bg-white/10 backdrop-blur-sm border border-white/20 text-green-700 py-3 px-4 rounded-lg hover:bg-white/20 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center justify-center space-x-2 font-medium bg-gradient-to-r from-green-50 to-emerald-50"
              >
                <SafeIcon 
              ...
              <div className="grid grid-cols-2 gap-2">
                {demoChatbot.donationAmounts.map((amount, index) => (
                  <button
                    ...
                    className="bg-white/10 backdrop-blur-sm border border-white/20 text-red-700 py-2 px-3 rounded-lg hover:bg-white/20 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center justify-center space-x-1 font-medium text-sm bg-gradient-to-r from-red-50 to-pink-50"
                  >
                    <SafeIcon 
            ...
            {/* Contact Action Buttons - Glassy Style */}
            <div className="p-4 bg-gray-50 border-t flex-shrink-0">
              <div className="flex space-x-2">
                <button
                  onClick={handleEmailClick}
                  className="flex-1 bg-white/10 backdrop-blur-sm border border-white/20 text-blue-700 py-2 px-3 rounded-lg hover:bg-white/20 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center justify-center space-x-1 text-sm font-medium bg-gradient-to-r from-blue-50 to-indigo-50"
                >
                  <SafeIcon 
                ...
                <button
                  ...
                  className="flex-1 bg-white/10 backdrop-blur-sm border border-white/20 text-purple-700 py-2 px-3 rounded-lg hover:bg-white/20 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center justify-center space-x-1 text-sm font-medium bg-gradient-to-r from-purple-50 to-violet-50"
                >
                  <SafeIcon 
              ...
              <form onSubmit={handleEmailFormSubmit} className="space-y-4">
                ...
                <div className="flex space-x-3">
                  <button
                    ...
                    className="flex-1 bg-white/10 backdrop-blur-sm border border-white/20 text-blue-700 py-2 px-4 rounded-lg hover:bg-white/20 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2 font-medium bg-gradient-to-r from-blue-50 to-indigo-50"
                  >
                    {isSubmitting ? (
                      <>
              ...
              <form onSubmit={handleVolunteerFormSubmit} className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {[
                      ...
                      <button
                        ...
                        className={`px-3 py-2 rounded-lg text-sm font-medium border flex items-center space-x-2 transition-all duration-300 transform hover:scale-105 ${
                          volunteerForm.availableDays[day]
                            ? 'bg-white/10 backdrop-blur-sm border-green-400 text-green-800 bg-gradient-to-r from-green-50 to-emerald-50 shadow-lg'
                ...
                <div className="flex space-x-3">
                  <button
                    ...
                    className="flex-1 bg-white/10 backdrop-blur-sm border border-white/20 text-green-700 py-2 px-4 rounded-lg hover:bg-white/20 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2 font-medium bg-gradient-to-r from-green-50 to-emerald-50"
                  >
